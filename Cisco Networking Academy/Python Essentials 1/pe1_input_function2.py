...
# It prints/outputs a specified message to the screen/consol window.

# 2. Built-in functions, contrary to user-defined functions, 
#are always available and don't have to be imported. 
...
# 4. Python strings are delimited with quotes, e.g., 
# "I am a string" (double quotes), or 'I am a string, too' (single quotes).

# 5. Computer programs are collections of instructions. 
# An instruction is a command to perform a specific task when executed, e.g., 
# to print a certain message to the screen.
...
print("\nMy", "name", "is", "Monty", "Python.", sep="-") 
# this changes the seperation between arguments to -
print("")
...
testvariable = 1000
print("\nForam precisos",testvariable,"cadaveres para podermos parar com a guerra.",sep=" ",end=" ")
print("Que merda.")